...
class RJsonTest extends PHPUnit_Framework_TestCase {
	...
	public function testCompressData() {
		...
		static::$compressedData = \AppLauncher\RJson\RJson::pack($this->collectionOfData);
	...
	public function testDecompressData() {
		$decompressedData = \AppLauncher\RJson\RJson::unpack(static::$compressedData);
	...
	public function testCompressArrayDataToJson() {
		static::$compressedData = \AppLauncher\RJson\RJson::pack($this->collectionOfData, $toJson = true);
	...
	public function testDecompressJsonData() {
		...
		$decompressedData = \AppLauncher\RJson\RJson::unpack(static::$compressedData, $isJson = true);
